...
test.describe('State Persistence', () => {
  ...
  test('states persist when navigating between pages', async ({ page }) => {
    ...
    if (await statesLink.isVisible()) {
      ...
      const imageExtractionLink = page.getByRole('button', { name: /extract images/i });
  ...
  test('local changes persist when navigating between pages', async ({ page }) => {
    ...
    if (await workflowsLink.isVisible()) {
      ...
      if (await statesLink.isVisible()) {
        ...
        const workflowsLinkAgain = page.getByRole('button', { name: /workflows/i });
