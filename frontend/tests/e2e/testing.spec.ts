...
test.describe("Software Testing System E2E", () => {
  ...
  test.describe("Test Run Details", () => {
    ...
    test("should display transitions timeline", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="transitions-list"]')
      ).toBeVisible();
    });
    ...
    test("should display deficiencies", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="deficiencies-list"]')
      ).toBeVisible();
    });
    ...
    test("should display coverage metrics", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="coverage-chart"]')
      ).toBeVisible();
    });
  });
  ...
  test.describe("Deficiencies Management", () => {
    test("should list all deficiencies", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="deficiency-card"]').first()
      ).toBeVisible();
    });
    ...
    test("should open deficiency details", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="deficiency-modal"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="deficiency-title"]')
      ).toBeVisible();
    });
    ...
    test("should assign deficiency to user", async ({ page }) => {
      ...
      // Verify assignment
      await expect(page.locator('[data-testid="assigned-user"]')).toContainText(
        "John Doe"
      );
    });
    ...
    test("should add comment to deficiency", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="comment"]').last()
    ...
    test("should view reproduction steps", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="reproduction-steps"]')
      ).toBeVisible();
    ...
    test("should view associated screenshots", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="screenshot"]').first()
      ).toBeVisible();
    });
  });
  ...
  test.describe("Analytics and Trends", () => {
    ...
    test("should display reliability statistics", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="reliability-stats"]')
      ).toBeVisible();
    });
