...
// The canonical corpus schemas (generated by schemars in qontinui-schemas)
// declare `$schema: draft/2020-12`. ajv's default export is a draft-07
// validator and throws `no schema with key or ref ".../2020-12/schema"`
// when it sees that meta-schema ref. Use ajv's bundled 2020 build so
// `conforms_to` validates the canonical schemas as authored.
