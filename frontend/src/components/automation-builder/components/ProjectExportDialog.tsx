      ...
      try {
        ...
        if (!isConnected) {
          ...
          toast.info("RAG processing skipped", {
            description: "No runner connected. Start qontinui-runner to enable RAG.",
          });
          return;
        }
            ...
            >
              ...
              {ragStatus === "completed" && ragProgress && (
                <p className="text-sm text-green-400">
                  {ragProgress.elementsProcessed} elements processed. RAG search
                  is now available in the runner.
                </p>
              )}
