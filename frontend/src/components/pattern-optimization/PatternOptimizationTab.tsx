...
export const PatternOptimizationTab: React.FC = () => {
  ...
  const createPatternFromStateImage = async () => {
    ...
    try {
      const response = await fetch(
        "/api/state-discovery/pattern/from-state-image",
        {
          method: "POST",
          headers: {
  ...
  const optimizePattern = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/masks/patterns/${selectedPattern.id}/optimize`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="col-span-1 bg-white rounded-lg shadow p-4">
          ...
          <div className="mt-4 pt-4 border-t">
            <h3 className="text-sm font-semibold mb-2">
              Create Pattern from StateImage
            </h3>
            <select
            ...
            <button
              ...
              disabled={
                !selectedStateImage || !patternName || isCreatingPattern
              }
