...
import {
  Search, MousePointer, Keyboard, GitBranch, Database,
  Navigation, Eye, MousePointer2, MousePointerClick, Move,
...
export const NODE_METADATA: Record<ActionType, NodeMetadata> = {
  ...
  FIND_STATE_IMAGE: {
    ...
    displayName: 'Find State Image',
    description: 'Find image from a specific state definition',
    category: 'find',
    icon: Eye,
    keywords: ['find', 'state', 'image', 'pattern', 'template'],
    tags: ['vision', 'state'],
  },
  VANISH: {
    type: 'VANISH',
  ...
  CLICK: {
    ...
    keywords: ['click', 'mouse', 'press', 'select', 'activate'],
    tags: ['interaction', 'basic'],
  },
  DOUBLE_CLICK: {
    type: 'DOUBLE_CLICK',
    displayName: 'Double Click',
    description: 'Double-click on an element or position',
    category: 'mouse',
    icon: MousePointerClick,
    keywords: ['double', 'click', 'mouse', 'open', 'activate'],
    tags: ['interaction'],
  },
  RIGHT_CLICK: {
    type: 'RIGHT_CLICK',
    ...
    category: 'mouse',
    icon: MousePointer2,
    keywords: ['right', 'click', 'context', 'menu', 'secondary'],
    tags: ['interaction'],
  },
  MOUSE_MOVE: {
    type: 'MOUSE_MOVE',
  ...
  RUN_PROCESS: {
    ...
    description: 'Execute another workflow or process',
    category: 'state',
    icon: Play,
    keywords: ['run', 'process', 'execute', 'workflow', 'call'],
 ...
 */
export function getRecommendedNodes(currentNodeType?: ActionType): ActionType[] {
