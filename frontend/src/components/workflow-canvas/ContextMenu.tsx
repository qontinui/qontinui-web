...
export function ContextMenu({ position, items, onClose, parent }: ContextMenuProps) {
          ...
          return (
            <div key={index} className="relative">
              ...
              >
                ...
                {hasSubmenu && (
                  <span className="flex-shrink-0 ml-2">{icons.chevronRight}</span>
                )}
              </button>
              ...
              {hasSubmenu && activeSubmenu === index && (
                <div
                  className="absolute left-full top-0 ml-1 min-w-[200px] bg-gray-800 border border-gray-700 rounded-lg shadow-xl overflow-hidden"
                >
                  <div className="py-1">
                    {item.submenu!.map((subItem, subIndex) => {
                      if (subItem.divider) {
                        return <div key={subIndex} className="my-1 border-t border-gray-700" />;
                      }
...
export function useContextMenu() {
      ...
      const items: ContextMenuItem[] = [
          ...
          submenu: [
            {
              ...
              submenu: [
                ...
                { label: 'Find State Image', onClick: () => console.log('Add Find State Image') },
            ...
            },
            {
              ...
              submenu: [
                ...
                { label: 'Double Click', onClick: () => console.log('Add Double Click') },
                { label: 'Right Click', onClick: () => console.log('Add Right Click') },
            ...
            },
            {
              ...
              submenu: [
                ...
                { label: 'Key Press', onClick: () => console.log('Add Key Press') },
        ...
        { divider: true },
        {
          ...
          submenu: [
            ...
            { divider: true },
            { label: 'Grid Size: 10px', onClick: () => console.log('Set grid 10') },
            { label: 'Grid Size: 20px', onClick: () => console.log('Set grid 20') },
            { label: 'Grid Size: 25px', onClick: () => console.log('Set grid 25') },
          ],
        },
      ];
  ...
  const openEdgeMenu = useCallback((position: { x: number; y: number }, edgeId: string) => {
    const items: ContextMenuItem[] = [
      {
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: 'Error Handling', onClick: () => console.log('Set error') },
          { label: 'Success Condition', onClick: () => console.log('Set success') },
          { label: 'Parallel Execution', onClick: () => console.log('Set parallel') },
        ],
      },
      { divider: true },
      {
      ...
      const items: ContextMenuItem[] = [
        {
          ...
          submenu: [
            ...
            { label: 'Align Bottom', onClick: () => console.log('Align bottom') },
            { label: 'Align Center Horizontal', onClick: () => console.log('Align center H') },
            { label: 'Align Center Vertical', onClick: () => console.log('Align center V') },
          ],
        },
        {
          label: 'Distribute',
          ...
          submenu: [
            { label: 'Distribute Horizontally', onClick: () => console.log('Distribute H') },
            { label: 'Distribute Vertically', onClick: () => console.log('Distribute V') },
            { label: 'Distribute Evenly', onClick: () => console.log('Distribute even') },
          ],
        },
        {
          label: 'Group',
