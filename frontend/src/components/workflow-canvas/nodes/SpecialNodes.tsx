  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 text-sm text-text-secondary italic">{text}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div
      className="
        ...
        bg-surface-canvas/50 border-2 border-border-default border-dashed
        rounded-lg p-4
        min-w-[250px]
        backdrop-blur-sm
      "
      style={{ pointerEvents: "all" }}
    >
      <div className="text-sm font-semibold text-text-muted mb-2 flex items-center gap-2">
        <svg
          className="w-4 h-4"
          fill="none"
          stroke="currentColor"
