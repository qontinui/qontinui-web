    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("core", "image_path", e.target.value)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("core", "mock", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("core", "headless", checked)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("core", "image_cache_size", parseInt(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("core", "auto_wait_timeout", parseFloat(e.target.value))}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="default_screen_index">Default Monitor Index (-1 for primary)</Label>
                <Input
                  id="default_screen_index"
                  type="number"
                  value={settings.monitor.default_screen_index}
                  onChange={(e) => updateSetting("monitor", "default_screen_index", parseInt(e.target.value))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("monitor", "multi_monitor_enabled", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("monitor", "search_all_monitors", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("monitor", "log_monitor_info", checked)}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mouse", "move_delay", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="pause_before_down">Pause Before Mouse Down (seconds)</Label>
                <Input
                  id="pause_before_down"
                  type="number"
                  step="0.1"
                  value={settings.mouse.pause_before_down}
                  onChange={(e) => updateSetting("mouse", "pause_before_down", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="pause_after_down">Pause After Mouse Down (seconds)</Label>
                <Input
                  id="pause_after_down"
                  type="number"
                  step="0.1"
                  value={settings.mouse.pause_after_down}
                  onChange={(e) => updateSetting("mouse", "pause_after_down", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mouse", "click_delay", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mouse", "drag_delay", parseFloat(e.target.value))}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mock", "click_duration", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mock", "type_duration", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mock", "find_duration", parseFloat(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("mock", "drag_duration", parseFloat(e.target.value))}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Screen capture and history configuration</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("screenshot", "save_snapshots", checked)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("screenshot", "path", e.target.value)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("screenshot", "max_history", parseInt(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateSetting("screenshot", "format", value)}
                >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("screenshot", "quality", parseInt(e.target.value))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("screenshot", "include_timestamp", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("screenshot", "capture_on_error", checked)}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("recording", "enabled", checked)}
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("recording", "fps", parseInt(e.target.value))}
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("recording", "max_duration_minutes", parseInt(e.target.value))}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("illustration", "enabled", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("illustration", "show_click", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("illustration", "show_drag", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("illustration", "show_find", checked)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("illustration", "highlight_color", e.target.value)}
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="highlight_thickness">Highlight Thickness (1-10)</Label>
                <Input
                  ...
                  onChange={(e) => updateSetting("illustration", "highlight_thickness", parseInt(e.target.value))}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Color analysis and clustering configuration</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("analysis", "kmeans_clusters", parseInt(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("analysis", "color_tolerance", parseInt(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("analysis", "min_contour_area", parseInt(e.target.value))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("analysis", "max_contour_area", parseInt(e.target.value))}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("dataset", "collect", checked)}
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("dataset", "include_screenshots", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("dataset", "include_actions", checked)}
                />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("testing", "timeout_multiplier", parseFloat(e.target.value))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("testing", "retry_failed", checked)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("testing", "max_retries", parseInt(e.target.value))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("testing", "screenshot_on_failure", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("testing", "verbose_logging", checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("testing", "parallel_execution", checked)}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateSetting("testing", "iteration", parseInt(e.target.value))}
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting("testing", "send_logs", checked)}
                />
              </div>
            </CardContent>
          </Card>
