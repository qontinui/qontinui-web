...
import { MoreVertical, XCircle, Trash2, Eye, AlertTriangle } from "lucide-react"
import { StatusIndicator } from "./StatusIndicator"
import { formatRelativeTime, isExpired, isExpiringSoon } from "@/utils/formatDuration"
...
export function RunnerTokenCard({
  ...
  const showExpiryWarning = !token.is_revoked && isExpiringSoon(token.expires_at);
      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-white mt-1">{formatRelativeTime(token.created_at)}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-white mt-1">
                  <Badge variant="outline" className="border-[#00D9FF]/50 text-[#00D9FF]">
              ...
              {token.last_ip_address && (
                <div className="col-span-2">
                  ...
                  <p className="text-white mt-1 font-mono text-xs">{token.last_ip_address}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-[#1A1A1B] border-gray-800">
              <DropdownMenuItem
      ...
      <AlertDialog open={showRevokeDialog} onOpenChange={setShowRevokeDialog}>
        <AlertDialogContent className="bg-[#1A1A1B] border-gray-800">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will immediately disconnect any active runners using this token and prevent
              future connections. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent className="bg-[#1A1A1B] border-gray-800">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this token and all its connection history. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
