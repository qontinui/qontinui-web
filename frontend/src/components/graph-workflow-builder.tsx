...
export function GraphWorkflowBuilder() {
  ...
  const handleNodeAdd = useCallback(
    (nodeType: ActionType) => {
      console.log('[GraphWorkflowBuilder] handleNodeAdd called with:', nodeType);
      console.log('[GraphWorkflowBuilder] selectedWorkflow:', selectedWorkflow?.id, selectedWorkflow?.name);
      console.log('[GraphWorkflowBuilder] Current actions count:', selectedWorkflow?.actions.length);
      ...
      console.log('[GraphWorkflowBuilder] Updated workflow actions count:', updatedWorkflow.actions.length);
      console.log('[GraphWorkflowBuilder] Updated workflow actions:', updatedWorkflow.actions);
  ...
  const handleDeleteWorkflow = useCallback(
    (workflowId: string) => {
      ...
      if (selectedWorkflow?.id === workflowId) {
        const remainingWorkflows = workflowList.filter((w) => w.id !== workflowId)
            ...
            <div className="border-b border-gray-800 bg-[#27272A]/50 p-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="text-sm text-gray-400">
                  ...
                  {Object.keys(selectedWorkflow.connections || {}).length} connections
                </div>
              </div>
