...
const nodes: DeploymentNode[] = [
  ...
  },
  {
    ...
    environment: "prod",
    description:
      "Production: https://qontinui.io - Next.js 14, Edge CDN, Automatic SSL, Preview Deployments",
  },
  {
    id: "nextjs-dev",
    name: "Next.js Dev",
    ...
    environment: "dev",
    description:
      "Development: localhost:3001 - Turbopack, Hot Reload, Fast Refresh, API proxy to :8000",
  },
  ...
  // API Gateway / Load Balancer Layer
  {
    ...
    environment: "prod",
    description:
      "Production ALB: qontinui-prod-py.eba-km2u4s23.eu-central-1.elasticbeanstalk.com - HTTPS (443), Health checks (/health)",
  },
  {
    id: "nginx-proxy",
    name: "Nginx Proxy",
    ...
    environment: "both",
    description:
      ".platform/nginx/conf.d/timeout.conf - 120s timeouts, CORS, proxy_pass to Uvicorn",
  },
  {
    id: "localhost",
    name: "WSL2 Network",
    ...
    environment: "dev",
    description:
      "Development: 0.0.0.0 binding required for WSL2, accessible from Windows browser",
  },
  ...
  // Backend Services Layer
  {
    ...
    environment: "prod",
    description:
      "Production: Docker + Uvicorn, Port 8000, Python 3.12, Poetry deps, Alembic migrations, SSL required",
  },
  {
    id: "fastapi-dev",
    name: "FastAPI (Local)",
    ...
    environment: "dev",
    description:
      "Development: localhost:8000, --reload, DEBUG=True, poetry run python run.py",
  },
  {
    id: "qontinui-api",
    name: "Qontinui API",
    ...
    environment: "dev",
    description:
      "Development: localhost:8001, Computer Vision, OpenCV, Pattern Matching (/find_all, /find_best)",
  },
  ...
  // Background Workers
  {
    ...
    environment: "dev",
    description:
      "run_worker.py - Background tasks: Email sending, Thumbnail generation, Async jobs (Not deployed to prod yet)",
  },
  {
    id: "elasticache",
    ...
    environment: "prod",
    description:
      "Planned: Multi-AZ, At-rest encryption, In-transit TLS, Session storage, Rate limiting, ARQ queue (REDIS_ENABLED=False currently)",
  },
  {
    id: "redis-dev",
    name: "Redis Docker",
    ...
    environment: "dev",
    description:
      "Development: localhost:6379, redis:7-alpine, Health checks, Max memory 512MB, LRU eviction",
  },
  ...
  // Database Layer
  {
    ...
    environment: "prod",
    description:
      "Production: PostgreSQL 16, qontinui-db.c16uiu02ugak.eu-central-1.rds.amazonaws.com, Multi-AZ, Auto backups (30d), SSL required, Connection pool (5+10)",
  },
  {
    id: "postgres-dev",
    ...
    environment: "dev",
    description:
      "Development: localhost:5432, postgres:15-alpine, qontinui_user/qontinui_db, Volume: postgres_data, Health checks",
  },
  {
    id: "alembic",
    ...
    environment: "both",
    description:
      "Database migrations: ./scripts/safe_migrate.sh (prevents multiple heads), alembic upgrade head, Version control",
  },
  ...
  // Object Storage Layer
  {
    ...
    environment: "prod",
    description:
      "Production: qontinui-production bucket, Presigned URLs (7d), Versioning, Lifecycle policies, IAM roles",
  },
  {
    id: "minio-dev",
    name: "MinIO Docker",
    ...
    environment: "dev",
    description:
      "Development: localhost:9000, S3-compatible, Console :9001, Auto-bucket creation, Volume: minio_data",
  },
  {
    id: "storage-service",
    ...
    environment: "both",
    description:
      "app/services/object_storage.py - Unified interface for S3/MinIO/Local, boto3 client, Presigned URLs, Metadata tracking",
  },
  ...
  // External Services Layer
  {
    ...
    environment: "prod",
    description:
      "Production: eu-central-1, Verification emails, Password reset, Beta welcome, HTML templates, IAM auth",
  },
  {
    id: "smtp-dev",
    name: "SMTP Fallback",
    ...
    environment: "dev",
    description:
      "Development: Port 587, TLS, Automatic fallback if SES fails, noreply@qontinui.com",
  },
  {
    id: "stripe",
    name: "Stripe API",
    ...
    environment: "both",
    description:
      "Payment processing: Subscriptions, Webhooks, Customer Portal, Test/Prod keys, /api/v1/billing/*",
  },
];
...
export function DeploymentArchitectureDiagram() {
  ...
  const getNodeColor = (type: DeploymentNode["type"]) => {
    switch (type) {
      ...
      case "external":
        return { main: "#EF4444", hover: "#DC2626" };
    }
  };
  ...
  const filteredNodes = nodes.filter((node) => {
    ...
    if (environmentFilter === "dev")
      return node.environment === "dev" || node.environment === "both";
    if (environmentFilter === "prod")
      return node.environment === "prod" || node.environment === "both";
    return true;
  });
    ...
    <div className="w-full h-full min-h-[900px] flex flex-col">
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-muted-foreground">
          Based on actual deployment configuration - Includes AWS services,
          Docker containers, ports, and connection details. Dashed lines
          indicate direct browser-to-storage access via presigned URLs or
          planned features.
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <svg viewBox="0 0 540 800" className="w-full h-full max-h-[900px]">
          ...
          {/* Layer Labels */}
          <text x="5" y="20" fill="#64748B" fontSize="12" fontWeight="600">
            Frontend Layer
          </text>
          <text x="5" y="130" fill="#64748B" fontSize="12" fontWeight="600">
            API Gateway
          </text>
          <text x="5" y="240" fill="#64748B" fontSize="12" fontWeight="600">
            Backend Services
          </text>
          <text x="5" y="350" fill="#64748B" fontSize="12" fontWeight="600">
            Workers & Cache
          </text>
          <text x="5" y="455" fill="#64748B" fontSize="12" fontWeight="600">
            Database Layer
          </text>
          <text x="5" y="570" fill="#64748B" fontSize="12" fontWeight="600">
            Object Storage
          </text>
          <text x="5" y="680" fill="#64748B" fontSize="12" fontWeight="600">
            External Services
          </text>
            ...
            <span
              className={`text-xs px-2 py-1 rounded ${
                nodes.find((n) => n.id === selectedNode)?.environment === "prod"
                  ? "bg-green-500 text-white"
                  : nodes.find((n) => n.id === selectedNode)?.environment ===
                      "dev"
                    ? "bg-blue-500 text-white"
