...
const nodes: WorkflowNode[] = [
  // Capture Layer
  {
    ...
    type: "capture",
    description:
      "ScreenshotUploader.tsx - Manual upload via UI (5 tabs: Upload, Project, Snapshots, Direct, Auto)",
  },
  {
    id: "automation-ws",
    name: "Automation WS",
    ...
    type: "capture",
    description:
      "WebSocket /api/v1/ws/automation/runner - Desktop runner captures and stores screenshots to S3/PostgreSQL",
  },
  {
    id: "snapshot-import",
    ...
    type: "capture",
    description:
      "/api/integration-testing/snapshots - Import from snapshot runs (read-only)",
  },
  ...
  // Storage Layer
  {
    ...
    type: "storage",
    description:
      "object_storage.py - Stores originals + 3 thumbnail sizes (256px thumb, 1024px medium, 2048px large)",
  },
  {
    id: "postgres-db",
    name: "PostgreSQL",
    ...
    type: "storage",
    description:
      "automation_screenshots, screenshots, annotations, storage_usage tables with thumbnail metadata",
  },
  {
    id: "indexeddb",
    name: "IndexedDB",
    ...
    type: "storage",
    description:
      "screenshot-db.ts - Browser-side temporary storage with base64 data URLs",
  },
  {
    id: "presigned-url",
    name: "Presigned URLs",
    ...
    type: "storage",
    description:
      "7-day expiration, generated on-demand from S3 keys for all image sizes",
  },
  ...
  // Processing Layer
  {
    ...
    type: "processing",
    description:
      "image_service.py:generate_thumbnails() - Creates 256px, 1024px, 2048px thumbnails via Pillow",
  },
  {
    id: "image-optimizer",
    ...
    type: "processing",
    description:
      "image_service.py:optimize_image() - Prepares images for WebP conversion",
  },
  {
    id: "webp-conversion",
    ...
    type: "processing",
    description:
      "image_service.py - WebP conversion with quality=85, method=6 for optimal compression",
  },
  {
    id: "arq-queue",
    ...
    type: "processing",
    description:
      "worker.py - Redis-backed async task queue for background thumbnail generation",
  },
  {
    ...
    type: "processing",
    description:
      "pattern_optimization_service.py:63-110 - Extract regions from screenshots",
  },
  {
    ...
    type: "processing",
    description:
      "ScreenshotCanvas + RegionSelector - Manual UI annotation tools",
  },
  {
    id: "state-clustering",
    ...
    type: "processing",
    description:
      "state_discovery_service.py - Timestamp-based automatic state detection",
  },
  ...
  // Analysis Layer
  {
    ...
    type: "analysis",
    description:
      "qontinui-api:8001 /find, /find_all - OpenCV template matching",
  },
  {
    id: "pattern-optimize",
    ...
    type: "analysis",
    description:
      "backend:8000 /optimize-pattern - Similarity matrix, statistics, strategy evaluation",
  },
  {
    id: "ml-detection",
    name: "ML Detection",
    ...
    type: "analysis",
    description:
      "analyzer_results, detected_elements, fused_elements - Multi-analyzer fusion",
  },
  ...
  // UI Layer
  {
    ...
    type: "ui",
    description:
      "EnhancedImageLibrary.tsx - Uses thumb (256px) URLs for fast grid rendering with lazy loading",
  },
  {
    ...
    type: "ui",
    description:
      "ScreenshotCanvas.tsx - Progressive loading: medium (1024px) → large (2048px) → original",
  },
  {
    ...
    type: "ui",
    description:
      "PatternOptimizationTab.tsx - Region selection, analysis panel, results display",
  },
];
    ...
    <div className="w-full h-full min-h-[800px] flex flex-col">
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-muted-foreground">
          Based on actual implementation - Includes file paths and API
          endpoints. Dashed lines indicate background processes or feedback
          loops.
        </p>
        <p className="text-xs text-green-600 font-semibold mt-1">
          All improvements implemented - thumbnails (256px/1024px/2048px), WebP
          optimization (quality=85, method=6), background processing (ARQ), and
