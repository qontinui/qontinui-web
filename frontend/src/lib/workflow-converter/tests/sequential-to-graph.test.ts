...
import { SequentialToGraphConverter, convertSequentialToGraph } from '../sequential-to-graph-converter';
...
import { IfActionConfig, LoopActionConfig, SwitchActionConfig, TryCatchActionConfig } from '../../action-schema/configs/control-flow-actions';
...
describe('SequentialToGraphConverter', () => {
  ...
  describe('TRY_CATCH Action Conversion', () => {
    ...
    it('should warn about finally actions', () => {
      ...
      expect(result.warnings.some(w => w.includes('Finally actions'))).toBe(true);
    });
  ...
  describe('Complex Workflows', () => {
    ...
    it('should handle linear workflow with control flow at end', () => {
      ...
      expect(result.workflow.connections['action-1'].main?.[0][0].action).toBe('action-2');
  ...
  describe('Conversion Statistics', () => {
    it('should track actions converted', () => {
      const actions: Action[] = [
        { id: '1', type: 'CLICK', config: {} as ClickActionConfig, position: [0, 0] },
        { id: '2', type: 'CLICK', config: {} as ClickActionConfig, position: [0, 0] },
        { id: '3', type: 'CLICK', config: {} as ClickActionConfig, position: [0, 0] },
      ];
