 ...
 *
 * Example: To add a new migration from 2.0.0 to 2.1.0:
 * 1. Create migrations/v2.0.0-to-v2.1.0.ts
 * 2. Import it here: import { migrationV2ToV21 } from './v2.0.0-to-v2.1.0';
