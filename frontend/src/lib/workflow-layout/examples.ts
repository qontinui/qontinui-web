    ...
    actions: [
      {
        ...
        config: { target: "login-button" } as unknown,
        position: [0, 0],
      },
      {
        id: "type-username",
        type: "TYPE",
        name: "Type Username",
        config: { text: "user@example.com" } as unknown,
        position: [0, 0],
      },
      {
        id: "type-password",
        type: "TYPE",
        name: "Type Password",
        config: { text: "password123" } as unknown,
        position: [0, 0],
      },
      {
        id: "click-submit",
        type: "CLICK",
        name: "Click Submit",
        config: { target: "submit-button" } as unknown,
        position: [0, 0],
      },
    ],
    connections: {
    ...
    actions: [
      {
        ...
        config: { target: "success-message" } as unknown,
        position: [0, 0],
      },
      {
        id: "branch-decision",
        type: "IF",
        name: "Element Exists?",
        config: { condition: "result === true" } as unknown,
        position: [0, 0],
      },
      {
        id: "success-path",
        type: "CLICK",
        name: "Click Continue",
        config: { target: "continue-button" } as unknown,
        position: [0, 0],
      },
      {
        id: "failure-path",
        type: "CLICK",
        name: "Click Retry",
        config: { target: "retry-button" } as unknown,
        position: [0, 0],
      },
      {
        id: "final-action",
        ...
        config: { filename: "result.png" } as unknown,
        position: [0, 0],
      },
    ],
    connections: {
    ...
    actions: [
      {
        ...
        type: "GET_VARIABLE",
        name: "Get Items List",
        config: { variableName: "items" } as unknown,
        position: [0, 0],
      },
      {
        id: "loop-items",
      ...
      },
      {
        ...
        type: "CLICK",
        name: "Click Item",
        config: { target: "current-item" } as unknown,
        position: [0, 0],
      },
      {
        id: "validate-item",
        type: "EXISTS",
        name: "Validate Item",
        config: { target: "item-validated" } as unknown,
        position: [0, 0],
      },
      {
        id: "complete",
        ...
        config: { filename: "complete.png" } as unknown,
        position: [0, 0],
      },
    ],
    connections: {
    ...
    actions: [
      {
        ...
        type: "GET_VARIABLE",
        name: "Get Status",
        config: { variableName: "status" } as unknown,
        position: [0, 0],
      },
      {
        id: "switch-status",
      ...
      },
      {
        ...
        config: { target: "ack-button" } as unknown,
        position: [0, 0],
      },
      {
        id: "handle-error",
        type: "SCREENSHOT",
        name: "Capture Error",
        config: { filename: "error.png" } as unknown,
        position: [0, 0],
      },
      {
        id: "handle-default",
        type: "SCREENSHOT",
        name: "Unknown Status",
        config: { filename: "unknown.png" } as unknown,
        position: [0, 0],
      },
    ],
    connections: {
    ...
    actions: [
      {
        ...
        type: "CLICK",
        name: "Start Process",
        config: { target: "start-button" } as unknown,
        position: [0, 0],
      },
      {
        id: "check-condition",
        ...
        config: { condition: "value > 10" } as unknown,
        position: [0, 0],
      },
      {
        id: "path-a",
        type: "CLICK",
        name: "Process Path A",
        config: { target: "path-a-button" } as unknown,
        position: [0, 0],
      },
      {
        id: "path-b",
      ...
      },
      {
        ...
        type: "SCREENSHOT",
        name: "Merge Point",
        config: { filename: "merged.png" } as unknown,
        position: [0, 0],
      },
    ],
    connections: {
  ...
  const workflow: Workflow = {
    ...
    actions: [
      ...
      },
      {
        ...
        config: { target: "risky-element" } as unknown,
        position: [0, 0],
      },
      {
        id: "success-action",
        ...
        config: { filename: "success.png" } as unknown,
        position: [0, 0],
      },
      {
        id: "error-handler",
      ...
      },
      {
        ...
        type: "SCREENSHOT",
        name: "Final State",
        config: { filename: "final.png" } as unknown,
        position: [0, 0],
      },
    ],
    connections: {
...
export function createLayoutStylesComparison(): Record<string, Workflow> {
  const baseWorkflow: Workflow = {
    ...
    format: "graph",
    actions: [
      { id: "a1", type: "CLICK", config: {} as unknown, position: [0, 0] },
      { id: "a2", type: "TYPE", config: {} as unknown, position: [0, 0] },
      { id: "if1", type: "IF", config: {} as unknown, position: [0, 0] },
      { id: "a3", type: "CLICK", config: {} as unknown, position: [0, 0] },
      { id: "a4", type: "CLICK", config: {} as unknown, position: [0, 0] },
      { id: "a5", type: "SCREENSHOT", config: {} as unknown, position: [0, 0] },
    ],
    connections: {
      a1: { main: [[{ action: "a2", type: "main", index: 0 }]] },
