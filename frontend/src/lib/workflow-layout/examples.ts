    ...
    actions: [
      {
        ...
        config: { target: 'login-button' } as any,
        position: [0, 0],
      },
      {
        id: 'type-username',
        type: 'TYPE',
        name: 'Type Username',
        config: { text: 'user@example.com' } as any,
        position: [0, 0],
      },
      {
        id: 'type-password',
        type: 'TYPE',
        name: 'Type Password',
        config: { text: 'password123' } as any,
        position: [0, 0],
      },
      {
        id: 'click-submit',
        type: 'CLICK',
        name: 'Click Submit',
        config: { target: 'submit-button' } as any,
        position: [0, 0],
      },
    ],
    connections: {
      'click-login': { main: [[{ action: 'type-username', type: 'main', index: 0 }]] },
      'type-username': { main: [[{ action: 'type-password', type: 'main', index: 0 }]] },
      'type-password': { main: [[{ action: 'click-submit', type: 'main', index: 0 }]] },
    },
  };
    ...
    actions: [
      {
        ...
        config: { target: 'success-message' } as any,
        position: [0, 0],
      },
      {
        id: 'branch-decision',
        type: 'IF',
        name: 'Element Exists?',
        config: { condition: 'result === true' } as any,
        position: [0, 0],
      },
      {
        id: 'success-path',
        type: 'CLICK',
        name: 'Click Continue',
        config: { target: 'continue-button' } as any,
        position: [0, 0],
      },
      {
        id: 'failure-path',
        type: 'CLICK',
        name: 'Click Retry',
        config: { target: 'retry-button' } as any,
        position: [0, 0],
      },
      {
        id: 'final-action',
        ...
        config: { filename: 'result.png' } as any,
        position: [0, 0],
      },
    ],
    connections: {
      'check-element': { main: [[{ action: 'branch-decision', type: 'main', index: 0 }]] },
      'branch-decision': {
        main: [
      ...
      'success-path': { main: [[{ action: 'final-action', type: 'main', index: 0 }]] },
      'failure-path': { main: [[{ action: 'final-action', type: 'main', index: 0 }]] },
    },
  };
    ...
    actions: [
      {
        ...
        type: 'GET_VARIABLE',
        name: 'Get Items List',
        config: { variableName: 'items' } as any,
        position: [0, 0],
      },
      {
        id: 'loop-items',
      ...
      },
      {
        ...
        type: 'CLICK',
        name: 'Click Item',
        config: { target: 'current-item' } as any,
        position: [0, 0],
      },
      {
        id: 'validate-item',
        type: 'EXISTS',
        name: 'Validate Item',
        config: { target: 'item-validated' } as any,
        position: [0, 0],
      },
      {
        id: 'complete',
        ...
        config: { filename: 'complete.png' } as any,
        position: [0, 0],
      },
    ],
    connections: {
      'get-items': { main: [[{ action: 'loop-items', type: 'main', index: 0 }]] },
      'loop-items': { main: [[{ action: 'process-item', type: 'main', index: 0 }]] },
      'process-item': { main: [[{ action: 'validate-item', type: 'main', index: 0 }]] },
      'validate-item': { main: [[{ action: 'complete', type: 'main', index: 0 }]] },
    },
  };
    ...
    actions: [
      {
        ...
        type: 'GET_VARIABLE',
        name: 'Get Status',
        config: { variableName: 'status' } as any,
        position: [0, 0],
      },
      {
        id: 'switch-status',
      ...
      },
      {
        ...
        config: { target: 'ack-button' } as any,
        position: [0, 0],
      },
      {
        id: 'handle-error',
        type: 'SCREENSHOT',
        name: 'Capture Error',
        config: { filename: 'error.png' } as any,
        position: [0, 0],
      },
      {
        id: 'handle-default',
        type: 'SCREENSHOT',
        name: 'Unknown Status',
        config: { filename: 'unknown.png' } as any,
        position: [0, 0],
      },
    ],
    connections: {
      'get-status': { main: [[{ action: 'switch-status', type: 'main', index: 0 }]] },
      'switch-status': {
        main: [
    ...
    actions: [
      {
        ...
        type: 'CLICK',
        name: 'Start Process',
        config: { target: 'start-button' } as any,
        position: [0, 0],
      },
      {
        id: 'check-condition',
        ...
        config: { condition: 'value > 10' } as any,
        position: [0, 0],
      },
      {
        id: 'path-a',
        type: 'CLICK',
        name: 'Process Path A',
        config: { target: 'path-a-button' } as any,
        position: [0, 0],
      },
      {
        id: 'path-b',
      ...
      },
      {
        ...
        type: 'SCREENSHOT',
        name: 'Merge Point',
        config: { filename: 'merged.png' } as any,
        position: [0, 0],
      },
    ],
    connections: {
      start: { main: [[{ action: 'check-condition', type: 'main', index: 0 }]] },
      'check-condition': {
        main: [
  ...
  const workflow: Workflow = {
    ...
    actions: [
      ...
      },
      {
        ...
        config: { target: 'risky-element' } as any,
        position: [0, 0],
      },
      {
        id: 'success-action',
        ...
        config: { filename: 'success.png' } as any,
        position: [0, 0],
      },
      {
        id: 'error-handler',
      ...
      },
      {
        ...
        type: 'SCREENSHOT',
        name: 'Final State',
        config: { filename: 'final.png' } as any,
        position: [0, 0],
      },
    ],
    connections: {
      ...
      'success-action': { main: [[{ action: 'final', type: 'main', index: 0 }]] },
      'error-handler': { main: [[{ action: 'final', type: 'main', index: 0 }]] },
    },
  };
...
export function createLayoutStylesComparison(): Record<string, Workflow> {
  const baseWorkflow: Workflow = {
    ...
    actions: [
      ...
      { id: 'a5', type: 'SCREENSHOT', config: {} as any, position: [0, 0] },
    ],
    connections: {
      a1: { main: [[{ action: 'a2', type: 'main', index: 0 }]] },
...
export function createComplexNestedExample(): Workflow {
  const workflow: Workflow = {
    ...
    format: 'graph',
    actions: [
      { id: 'start', type: 'CLICK', name: 'Start', config: {} as any, position: [0, 0] },
      { id: 'get-items', type: 'GET_VARIABLE', name: 'Get Items', config: {} as any, position: [0, 0] },
      { id: 'loop-items', type: 'LOOP', name: 'For Each Item', config: {} as any, position: [0, 0] },
      { id: 'check-type', type: 'IF', name: 'Check Type', config: {} as any, position: [0, 0] },
      { id: 'type-a', type: 'CLICK', name: 'Handle Type A', config: {} as any, position: [0, 0] },
      { id: 'type-b-check', type: 'IF', name: 'Type B Subcheck', config: {} as any, position: [0, 0] },
      { id: 'type-b1', type: 'CLICK', name: 'Type B1', config: {} as any, position: [0, 0] },
      { id: 'type-b2', type: 'TYPE', name: 'Type B2', config: {} as any, position: [0, 0] },
      { id: 'validate', type: 'EXISTS', name: 'Validate', config: {} as any, position: [0, 0] },
      { id: 'screenshot', type: 'SCREENSHOT', name: 'Screenshot', config: {} as any, position: [0, 0] },
      { id: 'complete', type: 'SCREENSHOT', name: 'Complete', config: {} as any, position: [0, 0] },
    ],
    connections: {
      start: { main: [[{ action: 'get-items', type: 'main', index: 0 }]] },
      'get-items': { main: [[{ action: 'loop-items', type: 'main', index: 0 }]] },
      'loop-items': { main: [[{ action: 'check-type', type: 'main', index: 0 }]] },
      'check-type': {
        main: [
