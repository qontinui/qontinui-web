 ...
 *
 * Accepts batched performance events from the UI Bridge BrowserEventCapture
 * and appends them as JSONL to .dev-logs/perf-events.jsonl.
...
const JSONL_PATH = join(DEV_LOGS_DIR, "perf-events.jsonl");
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error("[perf-events] Failed to write:", error);
