...
export async function GET(request: NextRequest) {
  try {
    ...
    if (accessTokenCookie?.value) {
      ...
      console.log(
        "[AutomationStreaming API Route] Using token from Authorization header"
      );
    }

    if (!accessToken) {
      console.error(
        "[AutomationStreaming API Route] No access token found in cookie or header"
      );
    ...
    console.log(
      "[AutomationStreaming API Route] Attempting to fetch from backend..."
    );
    ...
    console.log(
      "[AutomationStreaming API Route] Backend response status:",
      response.status
    );
    console.log(
      "[AutomationStreaming API Route] Backend response ok:",
      response.ok
    );
    ...
    console.error(
      "[AutomationStreaming API Route] Error name:",
      (error as Error).name
    );
    console.error(
      "[AutomationStreaming API Route] Error message:",
      (error as Error).message
    );
    console.error(
      "[AutomationStreaming API Route] Error stack:",
