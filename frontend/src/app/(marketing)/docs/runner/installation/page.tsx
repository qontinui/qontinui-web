    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <Alert className="mb-8 border-blue-300 bg-blue-50">
        ...
        <AlertDescription className="text-slate-700">
          ...
          <Link href="/runner/download" className="underline text-blue-600 hover:text-blue-800">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4">Standard Installation</h3>
            <ol className="space-y-4">
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    ...
                    <Link href="/runner/download" className="text-blue-600 underline">
                      download page
                    </Link>
                  </p>
                </div>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Double-click the <code className="bg-slate-100 px-1 py-0.5 rounded">.msi</code> file
                  </p>
                </div>
              </li>
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <Alert className="mt-2 border-amber-300 bg-amber-50">
                    ...
                    <AlertDescription className="text-sm">
                      <strong>Expected warning:</strong> "Windows protected your PC" - this appears because
                      the app is not yet code-signed ($200/year). The software is safe and open source.
                    </AlertDescription>
                  </Alert>
            ...
            <ol className="space-y-4">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Double-click to mount the disk image</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="font-bold text-blue-600 flex-shrink-0">3.</span>
              ...
              <li className="flex gap-3">
                <span className="font-bold text-blue-600 flex-shrink-0">4.</span>
                <div>
                  <p className="font-medium">First launch (Gatekeeper workaround)</p>
                  <Alert className="mt-2 border-amber-300 bg-amber-50">
                    <AlertCircle className="h-4 w-4 text-amber-600" />
                    <AlertDescription className="text-sm">
                      <strong>Expected:</strong> "Cannot open because developer cannot be verified" - this
                      is because the app is not yet notarized with Apple ($99/year).
                    </AlertDescription>
                  </Alert>
                  <div className="mt-4 bg-slate-50 border border-slate-200 rounded-lg p-4">
                    <p className="text-sm font-medium mb-2">Method 1 (Recommended):</p>
                    ...
                    <p className="text-sm font-medium mb-2">Method 2 (Terminal):</p>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4">AppImage Installation</h3>
            <ol className="space-y-4">
              <li className="flex gap-3">
                <span className="font-bold text-blue-600 flex-shrink-0">1.</span>
                <div>
                  <p className="font-medium">Download the AppImage</p>
                  <p className="text-sm text-slate-600">Universal format that works on most distros</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="font-bold text-blue-600 flex-shrink-0">2.</span>
          ...
          <Alert className="border-blue-300 bg-blue-50">
            <CheckCircle2 className="h-4 w-4 text-blue-600" />
            <AlertDescription>
              <strong>Good news!</strong> Linux doesn't require code signing. No security warnings!
            </AlertDescription>
          </Alert>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6">
          <p className="text-slate-700 mb-4">
            For security-conscious users, you can verify the integrity of your download using checksums.
            All releases include SHA-256 checksums on GitHub.
          </p>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm opacity-90">Learn how to create your first automation</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-slate-600">Complete guide to using Qontinui Runner</p>
          </Link>
        </div>
      </section>
    </div>
