...
import { Loader2, Play, Search, FileText, ArrowRight, FolderOpen } from 'lucide-react'
      ...
      <div className="flex items-center justify-center min-h-[400px] p-4">
        <Card className="bg-[#1A1A1B]/30 border-gray-800/50 border-dashed backdrop-blur-sm max-w-md">
          <CardContent className="p-12 text-center">
            ...
            <h4 className="text-xl font-semibold mb-2 text-gray-300">No workflows found</h4>
            <p className="text-gray-500 mb-6">
              Create workflows in the automation builder to verify their state transitions.
            </p>
            <Button
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-200">Verify Workflow States</h2>
          ...
          {Object.entries(groupedWorkflows).map(([category, categoryWorkflows]) => (
            <div key={category}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm text-gray-500">({categoryWorkflows.length})</span>
              </div>
