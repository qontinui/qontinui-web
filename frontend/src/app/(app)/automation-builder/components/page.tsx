...
export default function ComponentLibraryPage() {
  ...
  // State
  const [components, setComponents] = useState<SubflowComponent[]>(
  ...
  >("library");
  const [, setSelectedComponent] = useState<SubflowComponent | null>(null);

  // Computed values
  const usageStats = useMemo(
    () => generateUsageStats(components),
    [components]
  );
  const categoryStats = useMemo(
    () => generateCategoryStats(components),
    [components]
  );
                      ...
                      {components.length === 0 ? (
                        ...
                        <ComponentLibrary
                          ...
                          onUpdateComponent={(id, updates) => {
                            ...
                            if (component)
                              handleEditComponent({ ...component, ...updates });
                          }}
                    ...
                    <div className="space-y-4">
                      {categoryStats.map((stat) => {
                        const percentage = Math.round(
                          (stat.count / components.length) * 100
                        );
                        return (
                      ...
                      {[
                        {
                          ...
                          description:
                            "Give your component a name, description, and category",
                        },
                        {
                          step: "2",
                        ...
                        },
                        {
                          ...
                          description:
                            "Add actions and connections that make up the component logic",
                        },
                        {
                          step: "4",
                          title: "Test Component",
                          description:
                            "Test with different parameter values to ensure it works",
                        },
                        {
                          step: "5",
                          title: "Save and Tag",
                          description:
                            "Save your component and add tags for easy discovery",
                        },
                      ].map((item) => (
                        <div
                          key={item.step}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        },
                        {
                          ...
                          description:
                            "Add descriptions and examples for parameters",
                          icon: BookOpen,
                        },
                        {
                          title: "Version Control",
                          description:
                            "Use semantic versioning for tracking changes",
                          icon: Code,
                        },
                        {
                          title: "Error Handling",
                          description:
                            "Include proper error handling in components",
                          icon: AlertCircle,
                        },
                        {
                          title: "Reusability",
                          description:
                            "Design for reuse across different contexts",
                          icon: RefreshCw,
                        },
                      ].map((practice) => {
                  ...
                  <Alert className="bg-brand-success/10 border-brand-success/30">
                    ...
                    <AlertDescription>
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm">
                        <li>
                          Use tags to organize components by feature or use case
                        </li>
                        <li>
                          Export your library regularly for backup and sharing
                        </li>
                        <li>
                          Review usage statistics to identify optimization
                          opportunities
                        </li>
                        <li>
                          Create templates for common patterns to speed up
                          development
                        </li>
                        <li>
                          Document breaking changes when updating component
                          versions
                        </li>
                      </ul>
                    </AlertDescription>
              ...
              <div className="space-y-4 py-4">
                ...
                <Alert>
                  ...
                  <AlertDescription className="text-xs">
                    Imported components will be added to your library. Existing
                    components with the same ID will be updated.
                  </AlertDescription>
                </Alert>
              </div>
              <DialogFooter>
