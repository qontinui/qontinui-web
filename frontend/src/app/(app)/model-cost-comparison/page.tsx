...
export default function ModelCostComparisonPage() {
  ...
  return (
    // The (app) shell is h-screen overflow-hidden — pages own their scroll.
    <div className="h-full overflow-y-auto">
      <div className="container mx-auto max-w-6xl space-y-6 p-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              Subscriptions covering {tokensM}M tokens / month
            </CardTitle>
            <CardDescription>
                  ...
                  {combo ? (
                    <div className="space-y-1">
                      <p className="text-2xl font-bold tabular-nums">
                        {formatCurrency(
                          combinationPrice(combo, currency),
                          currency
                        )}
                      ...
                      <p className="text-sm text-muted-foreground">
                        {combinationLabel(combo)} · covers ~{combo.totalTokensM}
                        M tokens
                      </p>
                    </div>
                  ) : (
