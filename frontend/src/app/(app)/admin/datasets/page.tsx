        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-muted-foreground text-center mb-6 max-w-md">
              ...
              Datasets contain screenshots and annotations for training ML models.
            </p>
            <Button onClick={() => setShowImportDialog(true)}>
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold">{dataset.total_annotations}</div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-2xl font-bold">{dataset.reviewed_count}</div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {deleteConfirm?.total_annotations} annotations. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
