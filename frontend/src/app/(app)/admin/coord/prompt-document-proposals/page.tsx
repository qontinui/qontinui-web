 ...
 * loosening — is held as a pending proposal instead, UNLESS the tenant's
 * `policy_write` dial is `full`, at which point a classified loosening LANDS
 * announced rather than being held (plan
 * `2026-08-27-tenant-level-agent-authorable-stores.md`). So neither half of
 * this page may assert which directions can appear in it: proposals are read
 * and decided here, alongside the writes that did land — each marked with its
 * direction where coord classified one, each undoable.
 *
    ...
    >
      <div className="flex flex-wrap items-baseline gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          Edits your agents made to the policies coord serves them. Which edits
          have to wait for you and which land announced is your policy-write
          setting: whatever is waiting is at the top, and everything that landed
          is listed below — marked where it widened what agents may do, and
          undoable in one click. Nothing is waiting on you to keep working — an
          unreviewed proposal simply hasn&apos;t been applied.
        </p>
      </div>
