 ...
 * a dozen checkouts.
 *
 * Five sections, in the order an operator uses them:
 *
 ...
 * 4. **The corpus** — filter, search, and open one artifact in full.
 * 5. **Divergent copies** — where the library holds two versions that
