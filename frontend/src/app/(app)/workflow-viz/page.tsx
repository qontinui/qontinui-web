...
export default function WorkflowVisualizationPage() {
  ...
  // Data
  const [workflows, setWorkflows] = useState<(Workflow & { projectName?: string })[]>([])
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        setLoading(true)
        const [loadedWorkflows, loadedStates, loadedTransitions] = await Promise.all([
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0">
          ...
          <Card className="lg:col-span-1 flex flex-col">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge variant={selectedWorkflow.metadata?.viewMode === 'graph' ? 'default' : 'secondary'}>
          ...
          <Card className="lg:col-span-2 flex flex-col">
            <CardHeader>
              ...
              <CardDescription>
                Action {currentActionIndex + 1} of {selectedWorkflow.actions.length}
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              {loading ? 'Loading workflows...' : 'Select a workflow to visualize'}
            </p>
          </CardContent>
        </Card>
      )}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={currentActionIndex >= selectedWorkflow.actions.length - 1}
                  title="Step Forward"
                >
