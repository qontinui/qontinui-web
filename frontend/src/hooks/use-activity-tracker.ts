...
// Matches the Cognito app client's IdTokenValidity, which was raised from AWS's
// 60-minute default to 3h on the `qontinui-web` app client out-of-band (console
// change, not visible in this repo) — so an idle-timeout sign-out can't fire
// earlier than the session it is meant to bound.
