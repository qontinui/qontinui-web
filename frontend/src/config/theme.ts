...
export const styles = {
  ...
  // Inputs
  input:
    "bg-[#0A0A0B] border border-gray-700 text-white placeholder:text-gray-500 focus:border-[#00D9FF] focus:ring-1 focus:ring-[#00D9FF]",
  select:
    "bg-[#0A0A0B] border border-gray-700 text-white focus:border-[#00D9FF] focus:ring-1 focus:ring-[#00D9FF]",
