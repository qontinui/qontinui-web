...
describe('WorkflowDependencyAnalyzer', () => {
    ...
    testWorkflows = [
      ...
      // Workflow B - Depends on A
      {
        ...
        actions: [
          ...
          createAction('CLICK', { target: { image: 'button.png' } }, [100, 250], {
            id: 'b2',
          }),
        ],
        connections: {
    ...
    it('should handle multiple RUN_WORKFLOW actions', () => {
      const workflow: Workflow = {
        ...
        actions: [
          ...
          createAction('RUN_WORKFLOW', { workflowId: 'workflow-b' }, [100, 250], {
            id: 'm2',
          }),
        ],
        connections: {},
    ...
    it('should deduplicate dependencies', () => {
      const workflow: Workflow = {
        ...
        actions: [
          ...
          createAction('RUN_WORKFLOW', { workflowId: 'workflow-a' }, [100, 250], {
            id: 'd2',
          }),
        ],
        connections: {},
      ...
      const circularWorkflows: Workflow[] = [
        {
          ...
          format: 'graph',
          actions: [
            createAction('RUN_WORKFLOW', { workflowId: 'workflow-y' }, [100, 100], {
              id: 'x1',
            }),
          ],
          connections: {},
        },
        {
          ...
          format: 'graph',
          actions: [
            createAction('RUN_WORKFLOW', { workflowId: 'workflow-x' }, [100, 100], {
              id: 'y1',
            }),
          ],
          connections: {},
      ...
      const selfRefWorkflow: Workflow[] = [
        {
          ...
          format: 'graph',
          actions: [
            createAction('RUN_WORKFLOW', { workflowId: 'workflow-self' }, [100, 100], {
              id: 's1',
            }),
          ],
          connections: {},
  ...
  describe('getImpactAnalysis', () => {
    it('should calculate impact of changing a workflow', () => {
      ...
      expect(impact.allDependents.sort()).toEqual(['workflow-b', 'workflow-c'].sort());
    ...
    it('should show low impact for unused workflow', () => {
      ...
      const impact = analyzer.getImpactAnalysis(
        'workflow-unused',
        [...testWorkflows, unusedWorkflow]
      );
  ...
  describe('validateDependencies', () => {
    it('should validate correct workflow', () => {
      const validation = analyzer.validateDependencies(testWorkflows[1], testWorkflows);
    ...
    it('should detect missing workflow reference', () => {
      const invalidWorkflow: Workflow = {
        ...
        format: 'graph',
        actions: [
          createAction('RUN_WORKFLOW', { workflowId: 'non-existent' }, [100, 100], {
            id: 'i1',
          }),
        ],
        connections: {},
      ...
      const validation = analyzer.validateDependencies(invalidWorkflow, testWorkflows);
    ...
    it('should detect self-reference', () => {
      ...
      const validation = analyzer.validateDependencies(selfRefWorkflow, [selfRefWorkflow]);
