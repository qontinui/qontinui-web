    ...
    const builtins: TransitionTemplate[] = [
      {
        ...
        icon: "\uD83D\uDDB1\uFE0F",
        builtin: true,
        config: { type: "OutgoingTransition", workflows: [], timeout: 5000, retryCount: 3, staysVisible: false, activateStates: [], deactivateStates: [] },
      ...
      },
      {
        ...
        icon: "\uD83D\uDCDD",
        builtin: true,
        config: { type: "OutgoingTransition", workflows: [], timeout: 10000, retryCount: 2, staysVisible: false, activateStates: [], deactivateStates: [] },
      ...
      },
      {
        ...
        icon: "\uD83E\uDDED",
        builtin: true,
        config: { type: "OutgoingTransition", workflows: [], timeout: 15000, retryCount: 2, staysVisible: false, activateStates: [], deactivateStates: [] },
      ...
      },
      {
        ...
        icon: "\u23F1\uFE0F",
        builtin: true,
        config: { type: "OutgoingTransition", workflows: [], timeout: 3000, retryCount: 0, staysVisible: true, activateStates: [], deactivateStates: [] },
      ...
      },
      {
        ...
        icon: "\u2753",
        builtin: true,
        config: { type: "OutgoingTransition", workflows: [], timeout: 5000, retryCount: 1, staysVisible: true, activateStates: [], deactivateStates: [] },
      ...
      },
      {
        ...
        icon: "\u26A0\uFE0F",
        builtin: true,
        config: { type: "OutgoingTransition", workflows: [], timeout: 10000, retryCount: 5, staysVisible: false, activateStates: [], deactivateStates: [] },
