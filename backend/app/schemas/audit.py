...
class AuditLogBase(BaseModel):
    ...
    event_category: str | None = Field(
        None, description="Event category (e.g., permission_change)"
    )
    log_metadata: dict[str, Any] | None = Field(None, description="Additional metadata")
...
class AuditLogResponse(AuditLogBase):
    ...
    user_email: str | None = Field(
        None, description="Email of user who performed action"
    )
    user_username: str | None = Field(
        None, description="Username of user who performed action"
    )
    target_user_email: str | None = Field(
        None, description="Email of user affected by action"
    )
    target_user_username: str | None = Field(
        None, description="Username of user affected by action"
    )
...
class AuditLogStatsResponse(BaseModel):
    ...
    events_by_category: dict[str, int] = Field(
        ..., description="Count by event category"
    )
...
class AuditLogFilters(BaseModel):
    ...
    event_category: str | None = Field(None, description="Filter by event category")
