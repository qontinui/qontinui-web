...
from app.models.capture import (CaptureAction, CaptureDetectedElement,
...
from app.models.execution_tree_event import (ExecutionTreeEvent, TreeEventType,
                                             TreeNodeStatus, TreeNodeType)
...
from app.models.organization import (Organization, OrganizationInvitation,
                                     PermissionLevel, ProjectAccessControl,
                                     TeamMember, TeamRole)
...
from app.models.recording import (DiscoveredTransition, ProcessingLog,
                                  ProcessingPhase, Recording, RecordingContext,
                                  RecordingFrame, RecordingInteraction,
                                  RecordingStatus)
from app.models.recording_session import RecordingSession  # noqa
from app.models.render_log import (RenderImage, RenderImageType, RenderLog,
                                   RenderLogMutationType, RenderLogTrigger)
...
from app.models.snapshot import (Pattern, Screenshot, SnapshotAction,
                                 SnapshotMatch, SnapshotPattern, SnapshotRun)
from app.models.software_test_run import SoftwareTestRun, TestRunStatus
from app.models.state_discovery_result import (DiscoverySourceType,
...
from app.models.task_run import (  # New unified names; Backward compatibility aliases
    AITask, AITaskFinding, AITaskFindingActionType, AITaskFindingCategory,
    AITaskFindingSeverity, AITaskFindingStatus, AITaskSession, AITaskStatus,
    FindingActionType, FindingCategory, FindingSeverity, FindingStatus,
    TaskRun, TaskRunAutomation, TaskRunFinding, TaskRunSession, TaskRunStatus,
    TaskType)
...
from app.models.training_dataset import (AnnotationSource, DatasetSource,
                                         ElementType, ExportFormat,
                                         ExportJobStatus, ReviewStatus,
                                         TrainingDataset,
                                         TrainingDatasetAnnotation,
                                         TrainingDatasetExportJob,
                                         TrainingDatasetImage)
from app.models.training_job import (TrainingJob, TrainingJobModelType,
                                     TrainingJobStatus)
...
from app.models.video_capture import (ActionFrame, FrameIndex,
                                      HistoricalResult, InputEvent,
                                      InputEventType, StorageBackend,
                                      VideoCaptureSession)
...
from app.models.workflow_step_type import (GuiActionTypeConfig, StepTypeConfig,
                                           WorkflowPhaseConfig)
from app.models.workflow_test_association import (TriggerPoint,
