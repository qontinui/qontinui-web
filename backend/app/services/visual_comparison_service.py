"""
Visual comparison service for regression testing.

Provides operations for comparing screenshots against baselines:
- Run comparisons with various algorithms
- Generate diff images
- Manage review workflow
- Auto-create deficiencies for failed comparisons
"""
...
class VisualComparisonService:
    ...
    def __init__(self):
        """Initialize the visual comparison service."""
        self.storage = object_storage
        self.baseline_service = baseline_management_service
