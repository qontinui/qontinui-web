...
down_revision: Union[str, None] = 'c811d4fb1d00'
...
def upgrade() -> None:
    ...
    op.create_check_constraint(
        "chk_subscription_tier",
        "subscriptions",
        "tier IN ('free', 'hobby', 'pro')"
    )
    op.create_check_constraint(
...
def downgrade() -> None:
    ...
    op.drop_constraint("chk_region_analysis_job_status", "region_analysis_jobs", type_="check")
    ...
    op.drop_constraint("chk_automation_session_status", "automation_sessions", type_="check")
    op.drop_constraint("chk_project_access_permission", "project_access_control", type_="check")
    op.drop_constraint("chk_org_invitation_role", "organization_invitations", type_="check")
