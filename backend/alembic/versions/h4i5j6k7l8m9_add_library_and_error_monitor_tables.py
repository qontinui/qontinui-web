...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "auto_fix", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "fail_on_warning",
            sa.Boolean(),
        ...
        sa.Column(
            "is_critical", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "timeout_seconds",
            sa.Integer(),
    ...
    op.create_index(
        "ix_library_checks_created_by_user_id", "library_checks", ["created_by_user_id"]
    )
    ...
    op.create_index(
        "ix_library_check_groups_created_by_user_id",
        "library_check_groups",
        ["created_by_user_id"],
    )
    op.create_index(
        "ix_library_check_groups_project_id", "library_check_groups", ["project_id"]
    )
    ...
    op.create_index(
        "ix_library_shell_commands_created_by_user_id",
        "library_shell_commands",
        ["created_by_user_id"],
    )
    op.create_index(
        "ix_library_shell_commands_project_id", "library_shell_commands", ["project_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "timeout_ms", sa.Integer(), nullable=False, server_default=sa.text("30000")
        ),
        sa.Column(
            "tags",
            postgresql.JSONB(),
    ...
    op.create_index(
        "ix_library_saved_api_requests_created_by_user_id",
        "library_saved_api_requests",
        ["created_by_user_id"],
    )
    op.create_index(
        "ix_library_saved_api_requests_project_id",
        "library_saved_api_requests",
        ["project_id"],
    )
    ...
    op.create_index(
        "ix_library_contexts_created_by_user_id",
        "library_contexts",
        ["created_by_user_id"],
    )
    op.create_index(
        "ix_library_contexts_project_id", "library_contexts", ["project_id"]
    )
    ...
    op.create_index(
        "ix_library_macros_created_by_user_id", "library_macros", ["created_by_user_id"]
    )
    ...
    op.create_index(
        "ix_library_scriptlets_created_by_user_id",
        "library_scriptlets",
        ["created_by_user_id"],
    )
    op.create_index(
        "ix_library_scriptlets_project_id", "library_scriptlets", ["project_id"]
    )
    op.create_index(
        "ix_library_scriptlets_category", "library_scriptlets", ["category"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "resolved_by_task_run_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    ...
    op.create_index(
        "ix_error_monitor_entries_created_by_user_id",
        "error_monitor_entries",
        ["created_by_user_id"],
    )
    op.create_index(
        "ix_error_monitor_entries_project_id", "error_monitor_entries", ["project_id"]
    )
    op.create_index(
        "ix_error_monitor_entries_task_run_id", "error_monitor_entries", ["task_run_id"]
    )
    op.create_index(
        "ix_error_monitor_entries_severity", "error_monitor_entries", ["severity"]
    )
    op.create_index(
        "ix_error_monitor_entries_status", "error_monitor_entries", ["status"]
    )
    op.create_index(
        "ix_error_monitor_entries_error_type", "error_monitor_entries", ["error_type"]
    )
    op.create_index(
        "ix_error_monitor_entries_category", "error_monitor_entries", ["category"]
    )
