...
def downgrade() -> None:
    ...
    """
    # Drop index
    op.drop_index('ix_automation_screenshots_project_id', table_name='automation_screenshots')

    # Drop foreign key constraint
    op.drop_constraint('fk_automation_screenshots_project_id', 'automation_screenshots', type_='foreignkey')
