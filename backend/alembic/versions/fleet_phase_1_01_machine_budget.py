...
Revises: p2q3r4s5t6u7, v8w9x0y1z2a3
...
This revision also serves as a merge node for the two divergent heads
``p2q3r4s5t6u7`` (skills sharing) and ``v8w9x0y1z2a3`` (datetime tz
fix) — both must land before the fleet schema can extend ``coord.*``.
