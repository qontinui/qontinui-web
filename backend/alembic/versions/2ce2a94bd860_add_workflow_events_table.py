...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_workflow_events_user_id'), 'workflow_events', ['user_id'], unique=False)
    op.create_index(op.f('ix_workflow_events_event_type'), 'workflow_events', ['event_type'], unique=False)
    op.create_index(op.f('ix_workflow_events_device_id'), 'workflow_events', ['device_id'], unique=False)
    op.create_index(op.f('ix_workflow_events_run_id'), 'workflow_events', ['run_id'], unique=False)
    op.create_index(op.f('ix_workflow_events_seen'), 'workflow_events', ['seen'], unique=False)
