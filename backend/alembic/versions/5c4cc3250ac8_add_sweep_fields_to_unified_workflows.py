...
def upgrade() -> None:
    op.add_column('unified_workflows', sa.Column('enable_sweep', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    op.add_column('unified_workflows', sa.Column('max_sweep_iterations', sa.Integer(), server_default=sa.text('5'), nullable=False))
