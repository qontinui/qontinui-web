...
def upgrade() -> None:
    ...
    # Enable pgvector extension for VECTOR column type
    ...
    op.create_index(
        op.f("ix_users_last_login_at"), "users", ["last_login_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_conflict_logs_local_user_id"),
        "conflict_logs",
        ["local_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_conflict_logs_remote_user_id"),
        "conflict_logs",
        ["remote_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_conflict_logs_resource_id"),
        "conflict_logs",
        ["resource_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_device_sessions_device_fingerprint"),
        "device_sessions",
        ["device_fingerprint"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum(
                "RUNNER_EXPORT", "MANUAL_UPLOAD", "MERGED", name="dataset_source_enum"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_training_datasets_name"), "training_datasets", ["name"], unique=False
    )
    op.create_table(
        "usage_metrics",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "idx_invitation_email", "organization_invitations", ["email"], unique=False
    )
    op.create_index(
        "idx_invitation_org",
        "organization_invitations",
    ...
    op.create_index(
        "idx_invitation_token", "organization_invitations", ["token"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_org_user", "team_members", ["organization_id", "user_id"], unique=False
    )
    op.create_index(
        "idx_team_member_org", "team_members", ["organization_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "format",
            sa.Enum(
                "COCO", "YOLO", "PASCAL_VOC", "CSV", "JSONL", name="export_format_enum"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_training_dataset_images_image_hash"),
        "training_dataset_images",
        ["image_hash"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_automation_videos_id"), "automation_videos", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_edit_commands_applied_at"),
        "edit_commands",
        ["applied_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_edit_commands_project_id"),
        "edit_commands",
        ["project_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "job_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_embedding_generation_jobs_project_id"),
        "embedding_generation_jobs",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_embedding_generation_jobs_status"),
        "embedding_generation_jobs",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_embedding_generation_jobs_user_id"),
        "embedding_generation_jobs",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_project_access_org",
        "project_access_control",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "idx_project_access_project",
        "project_access_control",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        "idx_project_access_user", "project_access_control", ["user_id"], unique=False
    )
    op.create_table(
        "project_comments",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_project_comments_action_id"),
        "project_comments",
        ["action_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_project_comments_parent_comment_id"),
        "project_comments",
        ["parent_comment_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_project_comments_workflow_id"),
        "project_comments",
        ["workflow_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "pattern_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("image_width", sa.Integer(), nullable=False),
        sa.Column("image_height", sa.Integer(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_project_embeddings_image_id"),
        "project_embeddings",
        ["image_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_project_embeddings_pattern_id"),
        "project_embeddings",
        ["pattern_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_project_embeddings_project_pattern",
        "project_embeddings",
        ["project_id", "pattern_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_project_embeddings_state_id"),
        "project_embeddings",
        ["state_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_project_locks_project_id"),
        "project_locks",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_project_locks_resource_id"),
        "project_locks",
        ["resource_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_project_locks_user_id"), "project_locks", ["user_id"], unique=False
    )
    op.create_table(
        "project_versions",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_snapshot_runs_run_id"), "snapshot_runs", ["run_id"], unique=True
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "review_status",
            sa.Enum(
                "PENDING", "APPROVED", "REJECTED", "FLAGGED", name="review_status_enum"
            ),
            nullable=False,
        ),
        sa.Column("reviewer_notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="{error_type: count, ...}",
        ),
        sa.Column(
            "common_errors",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment='Array of {error: "", count: N}',
        ),
        ...
        sa.Column(
            ...
            sa.Numeric(precision=5, scale=2),
            nullable=True,
            comment="0-100, higher = more flaky",
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_automation_screenshots_project_id"),
        "automation_screenshots",
        ["project_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="{state_id: visit_count, ...}",
        ),
        sa.Column(
            "uncovered_transitions",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Array of transition IDs",
        ),
        sa.Column(
            "uncovered_states",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Array of state IDs",
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment='Array of {state: "", transition: ""}',
        ),
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Step number where cycle detected",
        ),
    ...
    op.create_index(
        op.f("ix_patterns_pattern_id"), "patterns", ["pattern_id"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        "idx_snapshot_actions_action_type",
        "snapshot_actions",
        ["action_type"],
        unique=False,
    )
    op.create_index(
        "idx_snapshot_actions_pattern_id",
        "snapshot_actions",
        ["pattern_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_snapshot_actions_success", "snapshot_actions", ["success"], unique=False
    )
    op.create_index(
        "idx_snapshot_actions_timestamp",
        "snapshot_actions",
        ["timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_snapshot_actions_action_type"),
        "snapshot_actions",
        ["action_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_snapshot_actions_id"), "snapshot_actions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_snapshot_actions_is_start_screenshot"),
        "snapshot_actions",
        ["is_start_screenshot"],
        unique=False,
    )
    op.create_index(
        op.f("ix_snapshot_actions_pattern_id"),
        "snapshot_actions",
        ["pattern_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_snapshot_actions_success"),
        "snapshot_actions",
        ["success"],
        unique=False,
    )
    op.create_index(
        op.f("ix_snapshot_actions_timestamp"),
        "snapshot_actions",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_snapshot_patterns_pattern_id",
        "snapshot_patterns",
        ["pattern_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_snapshot_patterns_id"), "snapshot_patterns", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_snapshot_patterns_pattern_id"),
        "snapshot_patterns",
        ["pattern_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=True,
            comment="Calculated duration in milliseconds",
        ),
        ...
        sa.Column(
            ...
            sa.String(length=255),
            nullable=True,
            comment="Where we actually ended up",
        ),
        sa.Column(
            "state_match",
            sa.Boolean(),
            nullable=True,
            comment="Did we reach expected state?",
        ),
        sa.Column(
            "input_data",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Variables/context at start",
        ),
        sa.Column(
            "output_data",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Variables/context at end",
        ),
        sa.Column(
            "path_sequence",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Array of state IDs visited",
        ),
        sa.Column(
            "path_depth", sa.Integer(), nullable=True, comment="How deep in exploration"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["snapshot_run_id"], ["snapshot_runs.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_video_capture_sessions_project_id",
        "video_capture_sessions",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        "idx_video_capture_sessions_snapshot_run_id",
        "video_capture_sessions",
        ["snapshot_run_id"],
        unique=False,
    )
    op.create_index(
        "idx_video_capture_sessions_started_at",
        "video_capture_sessions",
        ["started_at"],
        unique=False,
    )
    op.create_index(
        "idx_video_capture_sessions_workflow_id",
        "video_capture_sessions",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_video_capture_sessions_id"),
        "video_capture_sessions",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_video_capture_sessions_project_id"),
        "video_capture_sessions",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_video_capture_sessions_session_id"),
        "video_capture_sessions",
        ["session_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_video_capture_sessions_snapshot_run_id"),
        "video_capture_sessions",
        ["snapshot_run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_video_capture_sessions_started_at"),
        "video_capture_sessions",
        ["started_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_video_capture_sessions_workflow_id"),
        "video_capture_sessions",
        ["workflow_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_workflow_execution_history_execution_status"),
        "workflow_execution_history",
        ["execution_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_workflow_execution_history_session_id"),
        "workflow_execution_history",
        ["session_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_workflow_execution_history_workflow_id"),
        "workflow_execution_history",
        ["workflow_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["snapshot_action_id"], ["snapshot_actions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["video_capture_session_id"],
            ["video_capture_sessions.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        "idx_action_frames_action",
        "action_frames",
        ["snapshot_action_id"],
        unique=False,
    )
    op.create_index(
        "idx_action_frames_session",
        "action_frames",
        ["video_capture_session_id"],
        unique=False,
    )
    op.create_index(
        "idx_action_frames_type", "action_frames", ["frame_type"], unique=False
    )
    op.create_index(op.f("ix_action_frames_id"), "action_frames", ["id"], unique=False)
    op.create_index(
        op.f("ix_action_frames_snapshot_action_id"),
        "action_frames",
        ["snapshot_action_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_action_frames_video_capture_session_id"),
        "action_frames",
        ["video_capture_session_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "drag_path_points", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["screenshot_after_id"], ["automation_screenshots.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["screenshot_before_id"], ["automation_screenshots.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["session_id"], ["automation_sessions.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        op.f("ix_automation_input_events_id"),
        "automation_input_events",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_automation_input_events_session_id"),
        "automation_input_events",
        ["session_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_frame_index_keyframes",
        "frame_index",
        ["video_capture_session_id", "is_keyframe"],
        unique=False,
    )
    op.create_index(
        "idx_frame_index_session_frame",
        "frame_index",
        ["video_capture_session_id", "frame_number"],
        unique=False,
    )
    op.create_index(
        "idx_frame_index_session_timestamp",
        "frame_index",
        ["video_capture_session_id", "timestamp_ms"],
        unique=False,
    )
    op.create_index(op.f("ix_frame_index_id"), "frame_index", ["id"], unique=False)
    op.create_index(
        op.f("ix_frame_index_is_keyframe"), "frame_index", ["is_keyframe"], unique=False
    )
    op.create_index(
        op.f("ix_frame_index_timestamp_ms"),
        "frame_index",
        ["timestamp_ms"],
        unique=False,
    )
    op.create_index(
        op.f("ix_frame_index_video_capture_session_id"),
        "frame_index",
        ["video_capture_session_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "result_data_json", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("workflow_id", sa.Integer(), nullable=True),
        sa.Column("project_id", sa.UUID(), nullable=True),
    ...
    op.create_index(
        "idx_historical_action_type_success",
        "historical_results",
        ["action_type", "success"],
        unique=False,
    )
    op.create_index(
        "idx_historical_pattern_states",
        "historical_results",
        ["pattern_id", "active_states"],
        unique=False,
    )
    op.create_index(
        "idx_historical_project_pattern",
        "historical_results",
        ["project_id", "pattern_id"],
        unique=False,
    )
    op.create_index(
        ...
        "historical_results",
        ["pattern_id", "action_type", "success", "recorded_at"],
        unique=False,
    )
    op.create_index(
        "idx_historical_workflow_pattern",
        "historical_results",
        ["workflow_id", "pattern_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_action_type"),
        "historical_results",
        ["action_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_id"), "historical_results", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_historical_results_pattern_id"),
        "historical_results",
        ["pattern_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_project_id"),
        "historical_results",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_recorded_at"),
        "historical_results",
        ["recorded_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_snapshot_action_id"),
        "historical_results",
        ["snapshot_action_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_snapshot_run_id"),
        "historical_results",
        ["snapshot_run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_success"),
        "historical_results",
        ["success"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_video_capture_session_id"),
        "historical_results",
        ["video_capture_session_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historical_results_workflow_id"),
        "historical_results",
        ["workflow_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "event_data_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["video_capture_session_id"],
            ["video_capture_sessions.id"],
    ...
    op.create_index(
        "idx_input_events_type", "input_events", ["event_type"], unique=False
    )
    op.create_index(
        op.f("ix_input_events_event_type"), "input_events", ["event_type"], unique=False
    )
    op.create_index(op.f("ix_input_events_id"), "input_events", ["id"], unique=False)
    op.create_index(
        op.f("ix_input_events_timestamp_ms"),
        "input_events",
        ["timestamp_ms"],
        unique=False,
    )
    op.create_index(
        op.f("ix_input_events_video_capture_session_id"),
        "input_events",
        ["video_capture_session_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_screenshot_input_associations_log_id"),
        "screenshot_input_associations",
        ["log_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_screenshot_input_associations_screenshot_id"),
        "screenshot_input_associations",
        ["screenshot_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["action_id"], ["snapshot_actions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["pattern_id"], ["snapshot_patterns.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_snapshot_matches_action", "snapshot_matches", ["action_id"], unique=False
    )
    op.create_index(
        "idx_snapshot_matches_pattern", "snapshot_matches", ["pattern_id"], unique=False
    )
    op.create_index(
        op.f("ix_snapshot_matches_action_id"),
        "snapshot_matches",
        ["action_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_snapshot_matches_id"), "snapshot_matches", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_snapshot_matches_pattern_id"),
        "snapshot_matches",
        ["pattern_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum(
                "CRITICAL", "HIGH", "MEDIUM", "LOW", "INFO", name="deficiencyseverity"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Array of step descriptions",
        ),
        sa.Column(
            "reproduction_rate",
            sa.Numeric(precision=5, scale=2),
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="OS, browser, screen res, etc.",
        ),
        sa.Column(
            "preconditions",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Required setup",
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column(
            "width", sa.Integer(), nullable=False, comment="Image width in pixels"
        ),
        sa.Column(
            "height", sa.Integer(), nullable=False, comment="Image height in pixels"
        ),
        sa.Column(
            "captured_at",
    ...
    op.create_index(
        op.f("ix_test_screenshots_perceptual_hash"),
        "test_screenshots",
        ["perceptual_hash"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_test_screenshots_state_name"),
        "test_screenshots",
        ["state_name"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "file_size_bytes", sa.Integer(), nullable=True, comment="File size in bytes"
        ),
        sa.Column(
            "perceptual_hash",
            sa.String(length=256),
    ...
    op.create_index(
        op.f("ix_visual_baselines_approved_by_user_id"),
        "visual_baselines",
        ["approved_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_baselines_is_active"),
        "visual_baselines",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_baselines_perceptual_hash"),
        "visual_baselines",
        ["perceptual_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_baselines_project_id"),
        "visual_baselines",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_baselines_state_name"),
        "visual_baselines",
        ["state_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_baselines_workflow_id"),
        "visual_baselines",
        ["workflow_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "review_decision",
            sa.Enum("APPROVED", "REJECTED", "NEW_BASELINE", name="reviewdecision"),
            nullable=True,
    ...
    op.create_index(
        op.f("ix_visual_comparison_results_baseline_id"),
        "visual_comparison_results",
        ["baseline_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_deficiency_id"),
        "visual_comparison_results",
        ["deficiency_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_reviewed_by_user_id"),
        "visual_comparison_results",
        ["reviewed_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_screenshot_id"),
        "visual_comparison_results",
        ["screenshot_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_state_name"),
        "visual_comparison_results",
        ["state_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_status"),
        "visual_comparison_results",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_test_run_id"),
        "visual_comparison_results",
        ["test_run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_visual_comparison_results_transition_execution_id"),
        "visual_comparison_results",
        ["transition_execution_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_visual_baselines_workflow_id"), table_name="visual_baselines"
    )
    ...
    op.drop_index(
        op.f("ix_visual_baselines_perceptual_hash"), table_name="visual_baselines"
    )
    op.drop_index(op.f("ix_visual_baselines_is_active"), table_name="visual_baselines")
    op.drop_index(
        op.f("ix_visual_baselines_approved_by_user_id"), table_name="visual_baselines"
    )
    ...
    op.drop_index(
        op.f("ix_test_screenshots_perceptual_hash"), table_name="test_screenshots"
    )
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_input_events_video_capture_session_id"), table_name="input_events"
    )
    ...
    op.drop_index(
        op.f("ix_historical_results_workflow_id"), table_name="historical_results"
    )
    op.drop_index(
        op.f("ix_historical_results_video_capture_session_id"),
    ...
    op.drop_index(
        op.f("ix_historical_results_success"), table_name="historical_results"
    )
    op.drop_index(
        op.f("ix_historical_results_snapshot_run_id"), table_name="historical_results"
    )
    op.drop_index(
        op.f("ix_historical_results_snapshot_action_id"),
        table_name="historical_results",
    ...
    op.drop_index(
        op.f("ix_historical_results_recorded_at"), table_name="historical_results"
    )
    op.drop_index(
        op.f("ix_historical_results_project_id"), table_name="historical_results"
    )
    op.drop_index(
        op.f("ix_historical_results_pattern_id"), table_name="historical_results"
    )
    op.drop_index(op.f("ix_historical_results_id"), table_name="historical_results")
    op.drop_index(
        op.f("ix_historical_results_action_type"), table_name="historical_results"
    )
    ...
    op.drop_index(
        op.f("ix_frame_index_video_capture_session_id"), table_name="frame_index"
    )
    ...
    op.drop_index(
        op.f("ix_automation_input_events_id"), table_name="automation_input_events"
    )
    op.drop_index(
        "ix_automation_input_events_event_type", table_name="automation_input_events"
    )
    op.drop_table("automation_input_events")
    op.drop_index(
        op.f("ix_action_frames_video_capture_session_id"), table_name="action_frames"
    )
    op.drop_index(
        op.f("ix_action_frames_snapshot_action_id"), table_name="action_frames"
    )
    ...
    op.drop_index(
        op.f("ix_workflow_execution_history_workflow_id"),
        table_name="workflow_execution_history",
    )
    op.drop_index(
        op.f("ix_workflow_execution_history_session_id"),
        table_name="workflow_execution_history",
    ...
    op.drop_index(
        op.f("ix_video_capture_sessions_workflow_id"),
        table_name="video_capture_sessions",
    )
    op.drop_index(
        op.f("ix_video_capture_sessions_started_at"),
        table_name="video_capture_sessions",
    ...
    op.drop_index(
        op.f("ix_video_capture_sessions_id"), table_name="video_capture_sessions"
    )
    op.drop_index(
        "idx_video_capture_sessions_workflow_id", table_name="video_capture_sessions"
    )
    op.drop_index(
        "idx_video_capture_sessions_started_at", table_name="video_capture_sessions"
    )
    op.drop_index(
        "idx_video_capture_sessions_snapshot_run_id",
        table_name="video_capture_sessions",
    ...
    op.drop_index(
        "idx_video_capture_sessions_project_id", table_name="video_capture_sessions"
    )
    ...
    op.drop_index(
        op.f("ix_snapshot_patterns_snapshot_run_id"), table_name="snapshot_patterns"
    )
    op.drop_index(
        op.f("ix_snapshot_patterns_pattern_id"), table_name="snapshot_patterns"
    )
    ...
    op.drop_index(
        op.f("ix_snapshot_actions_snapshot_run_id"), table_name="snapshot_actions"
    )
    op.drop_index(op.f("ix_snapshot_actions_pattern_id"), table_name="snapshot_actions")
    op.drop_index(
        op.f("ix_snapshot_actions_is_start_screenshot"), table_name="snapshot_actions"
    )
    op.drop_index(op.f("ix_snapshot_actions_id"), table_name="snapshot_actions")
    op.drop_index(
        op.f("ix_snapshot_actions_action_type"), table_name="snapshot_actions"
    )
    ...
    op.drop_index(
        "ix_training_dataset_annotations_source",
        table_name="training_dataset_annotations",
    )
    op.drop_index(
        "ix_training_dataset_annotations_review",
        table_name="training_dataset_annotations",
    ...
    op.drop_index(
        op.f("ix_project_embeddings_state_id"), table_name="project_embeddings"
    )
    op.drop_index(
        "ix_project_embeddings_project_pattern", table_name="project_embeddings"
    )
    op.drop_index(
        op.f("ix_project_embeddings_project_id"), table_name="project_embeddings"
    )
    op.drop_index(
        op.f("ix_project_embeddings_pattern_id"), table_name="project_embeddings"
    )
    op.drop_index(
        op.f("ix_project_embeddings_image_id"), table_name="project_embeddings"
    )
    op.drop_table("project_embeddings")
    op.drop_index(
        op.f("ix_project_comments_workflow_id"), table_name="project_comments"
    )
    op.drop_index(op.f("ix_project_comments_project_id"), table_name="project_comments")
    op.drop_index(
        op.f("ix_project_comments_parent_comment_id"), table_name="project_comments"
    )
    ...
    op.drop_index(
        op.f("ix_embedding_generation_jobs_user_id"),
        table_name="embedding_generation_jobs",
    )
    op.drop_index(
        op.f("ix_embedding_generation_jobs_status"),
        table_name="embedding_generation_jobs",
    ...
    op.drop_index(
        op.f("ix_automation_sessions_user_id"), table_name="automation_sessions"
    )
    op.drop_index(
    ...
    op.drop_index(
        "ix_training_dataset_images_reviewed", table_name="training_dataset_images"
    )
    op.drop_index(
        op.f("ix_training_dataset_images_image_hash"),
        table_name="training_dataset_images",
    )
    op.drop_index(
        "ix_training_dataset_images_dataset_hash", table_name="training_dataset_images"
    )
    op.drop_table("training_dataset_images")
    op.drop_index(
        "ix_training_dataset_export_jobs_status",
        table_name="training_dataset_export_jobs",
    )
    op.drop_index(
        "ix_training_dataset_export_jobs_dataset",
        table_name="training_dataset_export_jobs",
    ...
    op.drop_index(
        op.f("ix_organization_invitations_token"), table_name="organization_invitations"
    )
    ...
    op.drop_index(
        op.f("ix_device_sessions_device_fingerprint"), table_name="device_sessions"
    )
