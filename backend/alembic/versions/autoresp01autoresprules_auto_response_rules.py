...
down_revision chains off ``coord_plans_ingested_status`` — the single local
head as reported by ``alembic heads`` at authoring time; the alembic-heads-pr
CI gate is the authoritative single-head guard.
"""
