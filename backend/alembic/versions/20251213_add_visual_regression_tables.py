...
down_revision: str | None = "a8db8ecc8fa0"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_test_run_id"], ["software_test_runs.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["source_screenshot_id"], ["test_screenshots.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "ix_visual_baselines_project_id",
        "visual_baselines",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        "ix_visual_baselines_state_name",
        "visual_baselines",
        ["state_name"],
        unique=False,
    )
    op.create_index(
        "ix_visual_baselines_workflow_id",
        "visual_baselines",
        ["workflow_id"],
        unique=False,
    )
    op.create_index(
        "ix_visual_baselines_is_active", "visual_baselines", ["is_active"], unique=False
    )
    op.create_index(
        "ix_visual_baselines_perceptual_hash",
        "visual_baselines",
        ["perceptual_hash"],
        unique=False,
    )
    op.create_index(
        "ix_visual_baselines_approved_by_user_id",
        "visual_baselines",
        ["approved_by_user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["baseline_id"], ["visual_baselines.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["screenshot_id"], ["test_screenshots.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["deficiency_id"], ["test_deficiencies.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        "ix_visual_comparison_results_test_run_id",
        "visual_comparison_results",
        ["test_run_id"],
        unique=False,
    )
    op.create_index(
        "ix_visual_comparison_results_baseline_id",
        "visual_comparison_results",
        ["baseline_id"],
        unique=False,
    )
    op.create_index(
        "ix_visual_comparison_results_screenshot_id",
        "visual_comparison_results",
        ["screenshot_id"],
        unique=False,
    )
    op.create_index(
        "ix_visual_comparison_results_state_name",
        "visual_comparison_results",
        ["state_name"],
        unique=False,
    )
    op.create_index(
        "ix_visual_comparison_results_status",
        "visual_comparison_results",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_visual_comparison_results_reviewed_by_user_id",
        "visual_comparison_results",
        ["reviewed_by_user_id"],
        unique=False,
    )
    op.create_index(
        "ix_visual_comparison_results_deficiency_id",
        "visual_comparison_results",
        ["deficiency_id"],
        unique=False,
    )
    ...
    op.add_column(
        "test_screenshots",
        sa.Column("state_name", sa.String(length=500), nullable=True),
    )
    op.add_column(
        "test_screenshots",
        sa.Column("perceptual_hash", sa.String(length=256), nullable=True),
    ...
    op.create_index(
        "ix_test_screenshots_state_name",
        "test_screenshots",
        ["state_name"],
        unique=False,
    )
    op.create_index(
        "ix_test_screenshots_perceptual_hash",
        "test_screenshots",
        ["perceptual_hash"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_visual_comparison_results_deficiency_id",
        table_name="visual_comparison_results",
    )
    op.drop_index(
        "ix_visual_comparison_results_reviewed_by_user_id",
        table_name="visual_comparison_results",
    ...
    op.drop_index(
        "ix_visual_comparison_results_status", table_name="visual_comparison_results"
    )
    op.drop_index(
        "ix_visual_comparison_results_state_name",
        table_name="visual_comparison_results",
    ...
    op.drop_index(
        "ix_visual_baselines_project_state_active", table_name="visual_baselines"
    )
    op.drop_index(
        "ix_visual_baselines_approved_by_user_id", table_name="visual_baselines"
    )
