...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "platform", sa.String(length=50), nullable=False, server_default="expo"
        ),
    ...
    op.create_index(
        op.f("ix_push_devices_push_token"), "push_devices", ["push_token"], unique=True
    )
    op.create_index(
        op.f("ix_push_devices_is_active"), "push_devices", ["is_active"], unique=False
    )
