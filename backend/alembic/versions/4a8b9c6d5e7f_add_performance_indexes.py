...
def upgrade() -> None:
    ...
    # Index 1: Projects by user and creation date
    # Speeds up: "SELECT * FROM projects WHERE user_id = ? ORDER BY created_at DESC"
    op.create_index(
        "idx_projects_user_created", "projects", ["user_id", "created_at"], unique=False
    )
