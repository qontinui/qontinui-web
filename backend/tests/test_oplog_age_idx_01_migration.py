...
# MUST equal the revision's own `down_revision`: `main`'s single head at the
# 2026-09-13 re-point. The chain this revision was once serialised behind
# (#1218 / #989 / #1269) is fully on `main`. The block above `down_revision` in
# the revision itself carries the history.
