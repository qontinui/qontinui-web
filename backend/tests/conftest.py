...
os.environ["ACCESS_SECRET_KEY"] = "test-access-secret-key-minimum-32-characters-required"
os.environ["RESET_PASSWORD_SECRET_KEY"] = "test-reset-password-secret-key-min-32-chars-required"
os.environ["VERIFICATION_SECRET_KEY"] = "test-verification-secret-key-min-32-chars-required"
